...
class HighlightsControllerTest < ActionController::TestCase
  ...
  test "should create highlight" do
    assert_difference('Highlight.count') do
      post :create, highlight: { description: @highlight.description, name: @highlight.name, store_id: @highlight.store_id }
    end
  ...
  test "should update highlight" do
    patch :update, id: @highlight, highlight: { description: @highlight.description, name: @highlight.name, store_id: @highlight.store_id }
    assert_redirected_to highlight_path(assigns(:highlight))
  end
