...
class CrawlsControllerTest < ActionController::TestCase
  ...
  test "should create crawl" do
    assert_difference('Crawl.count') do
      post :create, crawl: { centre_id: @crawl.centre_id, description: @crawl.description, name: @crawl.name }
    end
  ...
  test "should update crawl" do
    patch :update, id: @crawl, crawl: { centre_id: @crawl.centre_id, description: @crawl.description, name: @crawl.name }
    assert_redirected_to crawl_path(assigns(:crawl))
  end
